...
class AdminMovimientos extends LucioPage{
	...
	public function parseSaldos(XTemplate $xtpl){
			...
			$xtpl->assign("saldo_ganancias", LucioUIUtils::formatMontoToView( UIServiceFactory::getUIVentaService()->getGanancias($criteria)) );
			...
			$xtpl->assign("saldo_pedidos", LucioUIUtils::formatMontoToView( UIServiceFactory::getUIMovimientoPedidoService()->getTotalesDia(new Datetime())) );
