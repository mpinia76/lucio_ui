<?php
namespace Lucio\UI\pages\proveedors;

use Lucio\UI\pages\LucioPage;

use Lucio\UI\components\filter\model\UIProveedorCriteria;

use Lucio\UI\components\grid\model\ProveedorGridModel;

use Lucio\UI\service\UIProveedorService;
 ...
 *
 */
class Proveedors extends LucioPage{
