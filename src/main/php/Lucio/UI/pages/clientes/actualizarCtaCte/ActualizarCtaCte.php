<?php
namespace Lucio\UI\pages\clientes\actualizarCtaCte;


use Lucio\UI\service\finder\ClienteFinder;

use Lucio\UI\service\finder\CuentaFinder;
...
class ActualizarCtaCte extends LucioPage{
	...
	public function __construct(){
		...
		/*if( LucioUIUtils::isCajaSelected() )
			$this->destino = LucioUIUtils::getCaja();*/
