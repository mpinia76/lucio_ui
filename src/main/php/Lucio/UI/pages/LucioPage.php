 ...
 * @since 01/03/2018
 */
abstract class LucioPage extends RastyPage{
	...
	public function getLinkLucio(){

		return LinkBuilder::getPageUrl( "Lucio") ;
    ...
    public function getLinkCompanias(){

        return LinkBuilder::getPageUrl( "Companias") ;

    }

    public function getLinkActionAgregarCompania(){

        return LinkBuilder::getActionUrl( "AgregarCompania") ;

    }

    public function getLinkActionModificarCompania(){

        return LinkBuilder::getActionUrl( "ModificarCompania") ;

    }

    public function getLinkCompaniaAgregar(){

        return LinkBuilder::getPageUrl( "CompaniaAgregar") ;
