<?php
namespace Lucio\UI\pages\gastos\pagar;
...
class GastoPagar extends LucioPage{
...
//
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign( "lbl_pendiente", $this->localize( "forma.pago.pendiente") );
			...
			$xtpl->assign( "linkPagarEfectivo", $this->getLinkActionPagarGasto($this->getGasto(), LucioUtils::getCuentaUnica(), $this->getBackTo()) );
