...
use Lucio\UI\components\filter\model\UITarjetaCriteria;
use Lucio\UI\components\filter\model\UICuentaCorrienteCriteria;
...
class UIMovimientoCajaService  implements IEntityGridService{
	...
	public function getTotalesDia( \Datetime $fecha ){
		...
		try {
			...
			return $service->getTotales(LucioUtils::getCuentaUnica(), $fecha );
