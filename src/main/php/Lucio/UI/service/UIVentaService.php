...
class UIVentaService  implements IEntityGridService{
	...
	public function cobrar(Venta $venta, Cuenta $cuenta, User $user, $monto, $tipoCliente){

		try {

			$service = ServiceFactory::getVentaService();

			return $service->cobrar($venta, $cuenta, $user, $monto, $tipoCliente);
	...
	public function cobrarCtaCte(Venta $venta, User $user, $monto, $tipoCliente){

		try {

			$service = ServiceFactory::getVentaService();

			return $service->cobrarCtaCte($venta, $user, $monto, $tipoCliente);
