...
namespace Lucio\UI\components\pdf\venta;
...
class VentaPDF extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		if( !empty($venta )){
			...
			$xtpl->assign( "fecha", LucioUIUtils::formatDateTimeToView($venta->getFecha()) );
            ...
            if ($venta->getCliente1()){
                $compania1 .='<tr><td colspan="2">
                            ...
                            <tr>
                            <td colspan="2">
                                <span style="font-size:12pt;">Nombre: '.$venta->getCliente1().$observaciones.'</span>
                            ...
                            <tr>
                            <td width="450px">
                                <span style="font-size:12pt;">Tel&eacute;fonos: '.$venta->getCliente1()->getTelefono().' - '.$venta->getCliente1()->getCelular().'</span>

                            </td>
                            <td>
                                <span style="font-size:12pt;">Email: '.$venta->getCliente1()->getMail().'</span>
            ...
            if ($venta->getCliente2()){
                $compania1 .='<tr><td colspan="2">
                            ...
                            <tr>
                            <td colspan="2">
                                <span style="font-size:12pt;">Nombre: '.$venta->getCliente2().$observaciones.'</span>
                            ...
                            <tr>
                            <td width="450px">
                                <span style="font-size:12pt;">Tel&eacute;fonos: '.$venta->getCliente2()->getTelefono().' - '.$venta->getCliente2()->getCelular().'</span>

                            </td>
                            <td>
                                <span style="font-size:12pt;">Email: '.$venta->getCliente2()->getMail().'</span>
			...
			foreach ($venta->getDevoluciones() as $devolucion) {
				...
				$htmlItem .='<tr><td>'.$devolucion->getProducto().'</td><td style="text-align: right;">'.$devolucion->getCantidad().'</td><td style="text-align: right;">'.LucioUIUtils::formatMontoToView( $devolucion->getPrecioUnitario() ).'</td><td style="text-align: right;">'.LucioUIUtils::formatMontoToView( $devolucion->getSubtotal() ).'</td></tr>';
	...
	<table cellspacing="0" cellpadding="0" border="1">
		...
		<tr><td colspan="4"></td></tr>
		<tr><td colspan="4"></td></tr>
			<tr><td style="text-align: right; font-weight: bold;" colspan="3">'.$this->localize( "venta.detalle.subtotal" ).'</td><td style="text-align: right;font-weight: bold;">'.LucioUIUtils::formatMontoToView( $venta->getMontoDevolucion() ).'</td></tr>
			...
			if ($venta->getMontoActualizado()) {
				$xtpl->assign( 'htmlMontoActualizado','<tr><td style="text-align: right; font-weight: bold;" colspan="3" width="616px">'.$this->localize('venta.montoActualizado').'</td><td style="text-align: right;font-weight: bold;" width="100px">'.LucioUIUtils::formatMontoToView($venta->getMontoActualizado()),'</td></tr>');
			}
			$xtpl->assign( "totales", LucioUIUtils::formatMontoToView( $venta->getMonto() ) );

			$pagadoCliente='';
			if ($venta->getMontoPagadoCliente()){
                $pagadoCliente .='<tr><td style="text-align: right; font-weight: bold;" colspan="3" width="616px">'.$this->localize( "venta.montoPagadoCliente" ).'</td><td style="text-align: right;font-weight: bold;" width="100px">'.LucioUIUtils::formatMontoToView( $venta->getMontoPagadoCliente() ).'</td></tr>';
            }
            $xtpl->assign( "pagadoCliente", $pagadoCliente );

            $pagadoCliente1='';
            if ($venta->getMontoPagadoCliente1()){
                $pagadoCliente1 .='<tr><td style="text-align: right; font-weight: bold;" colspan="3" width="616px">'.$this->localize( "venta.montoPagadoCliente1" ).'</td><td style="text-align: right;font-weight: bold;" width="100px">'.LucioUIUtils::formatMontoToView( $venta->getMontoPagadoCliente1() ).'</td></tr>';
            }
            $xtpl->assign( "pagadoCliente1", $pagadoCliente1 );
            $pagadoCliente2='';
            if ($venta->getMontoPagadoCliente2()){
                $pagadoCliente2 .='<tr><td style="text-align: right; font-weight: bold;" colspan="3" width="616px">'.$this->localize( "venta.montoPagadoCliente2" ).'</td><td style="text-align: right;font-weight: bold;" width="100px">'.LucioUIUtils::formatMontoToView( $venta->getMontoPagadoCliente2() ).'</td></tr>';
            }
            $xtpl->assign( "pagadoCliente2", $pagadoCliente2 );


			//$xtpl->assign( "pagado", LucioUIUtils::formatMontoToView( $venta->getMontoPagado() ) );
			$xtpl->assign( "adeudado", LucioUIUtils::formatMontoToView( $venta->getMontoDebe() ) );
