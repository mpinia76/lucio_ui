...
use Lucio\UI\components\grid\formats\GridEstadoPresupuestoFormat;
...
//		//TODO esto setearlo en el .rasty
	...
	protected function initModel() {
        ...
        $column = GridModelBuilder::buildColumn( "cliente1", "presupuesto.cliente1", 20, EntityGrid::TEXT_ALIGN_LEFT );
        $this->addColumn( $column );

        $column = GridModelBuilder::buildColumn( "cliente2", "presupuesto.cliente2", 20, EntityGrid::TEXT_ALIGN_LEFT );
        $this->addColumn( $column );
	...
	public function getRowStyleClass($item){
		...
		return LucioUIUtils::getEstadoPresupuestoCss($item->getEstado());
	...
	public function getHeaderContent(){
		...
		return 'Total: '.LucioUIUtils::formatMontoToView($service->getTotales($filter->getCriteria()));
	}
