...
//		//TODO esto setearlo en el .rasty
	...
	public function getMenuGroups( $item ){
		...
		if ($movimientoClass=='Lucio\Core\model\MovimientoVenta') {
	...
	public function getHeaderContent(){
		...
		return 'Bruto: <strong>'.LucioUIUtils::formatMontoToView($service->getTotales($criteria)).'</strong> Neto: <strong>'.LucioUIUtils::formatMontoToView($service->getGanancias($criteria)).'</strong>';
	}
