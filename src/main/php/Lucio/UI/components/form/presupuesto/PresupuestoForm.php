...
namespace Lucio\UI\components\form\presupuesto;
...
use Lucio\UI\service\finder\ComboFinder;
...
class PresupuestoForm extends Form{
	...
	public function __construct(){
        ...
        $this->addProperty("cliente1");
        $this->addProperty("cliente2");
	...
	public function getLinkActionAgregarCombo(){
		...
		return LinkBuilder::getActionAjaxUrl( "AgregarComboPresupuestoJson") ;
    ...
    public function getCompaniaFinderClazz(){

        return get_class( new CompaniaFinder() );
