...
namespace Lucio\UI\components\form\pedido;

use Lucio\UI\components\filter\model\UIProveedorCriteria;

use Lucio\UI\service\finder\ProveedorFinder;

use Lucio\UI\service\finder\ClienteFinder;

use Lucio\UI\service\finder\TipoProductoFinder;

use Lucio\UI\service\finder\MarcaProductoFinder;

use Lucio\UI\service\finder\ProductoFinder;
...
use Lucio\Core\model\DetallePedido;
...
class PedidoForm extends Form{
	...
	public function fillEntity($entity){
		...
		$detalles = LucioUIUtils::getDetallesPedidoSession();
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		foreach ($productos as $producto) {
			...
			//$xtpl->assign("logo", LucioUIUtils::getImagenProducto($producto));
